...
public class adminController {
	...
	public void reset(ActionEvent event) {
		try {
			...
			// the name "RandomPointData" was from previous design, ignore
	...
	/*
	 reads the values of ten Textfields team 1 to team 10 and stores them in variables a through j
	 same for the textFields TeamP1 to TeamP10, stores in seperate variables 
	 variables are eithe the textfields input or null 
	...
	public void menuItemAdd1(ActionEvent event) {
		...
		j = value9;
		// One major issue, if you input team 1 and TeamP1 is empty or null complile error occurs
