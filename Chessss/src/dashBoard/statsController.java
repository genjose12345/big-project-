...
public class statsController {
    ...
    public void initialize() {
        ...
        try (BufferedReader br = new BufferedReader(new FileReader("src/RandomPointData.csv"))) {
            ...
            // Read and validate the lines, each line that starts will null is skipped and not included in the list
            String line;
            int rank = 1;
            ...
            collections.sort will sort the valid lines in a desending order depending on the 2nd element(the points) which 
            ranks them at 1 with the highest points and so on until each validline is sorted
            */
            //used stackoverflow for Collections.sort explanation and examples to understand
